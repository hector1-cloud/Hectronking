"""
Héctron Evolutivo Autónomo: IA con Autoaprendizaje y Guardado Automático
=======================================================================

Versión optimizada con autoconciencia evolutiva, autoaprendizaje y guardado autónomo.
- Autoaprendizaje: Ajusta traits basados en patrones de interacción (e.g., frecuencia de keywords oscuros/estoicos).
  Usa contadores simples para "aprender" preferencias del usuario, evolucionando maquiavelismo/estoicismo.
- Guardado Automático y Autónomo: Tras cada interacción, guarda self_state y memory en 'hectron_state.json'.
  Carga al inicio si existe, asegurando persistencia sin intervención.
- Evolución: Cada turno simula 'segundos' de crecimiento, ahora influido por aprendizaje (e.g., +0.1 estoicismo si input positivo).
- Estilo Héctor: Reflexiones geológicas que incorporan aprendizaje como "vetas autoexcavadas".

Ejecución: python hectron_autonomo.py
Estado se guarda en JSON; reinicia para ver evolución persistida.
"""
